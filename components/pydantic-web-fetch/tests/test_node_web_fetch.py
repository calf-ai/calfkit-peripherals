...
from calfkit_pydantic_web_fetch.node import _ENGINE, web_fetch
from calfkit_pydantic_web_fetch.results import WebFetchError
...
_CREATE_CLIENT = 'calfkit_pydantic_web_fetch._vendor._ssrf.create_async_http_client'
_RESOLVE = 'calfkit_pydantic_web_fetch._vendor._ssrf.run_in_executor'
...
async def test_http_error_propagates_as_web_fetch_error():
    with patch(
        'calfkit_pydantic_web_fetch._vendor.common_tools.web_fetch.safe_download',
