...
providers) must import cleanly under the ``calfkit_hermes`` namespace — i.e.
...
WEB_MODULES = [
    "calfkit_hermes._vendor.agent.web_search_provider",
    "calfkit_hermes._vendor.agent.web_search_registry",
    "calfkit_hermes._vendor.tools.url_safety",
    "calfkit_hermes._vendor.tools.web_providers.ddgs",
    "calfkit_hermes._vendor.tools.web_providers.brave_free",
    "calfkit_hermes._vendor.tools.web_providers.searxng",
    "calfkit_hermes._vendor.tools.web_providers.tavily",
]
...
def test_provider_modules_have_no_bare_vendored_imports():
    ...
    for module in WEB_MODULES:
        rel = module.removeprefix("calfkit_hermes.").replace(".", "/") + ".py"
        path = src / "calfkit_hermes" / rel
...
def test_providers_self_register_into_vendored_registry():
    ...
    from calfkit_hermes._vendor.tools.web_providers.searxng import (
        SearXNGWebSearchProvider,
    )
    from calfkit_hermes._vendor.tools.web_providers.tavily import (
