...
from calfkit_hermes._vendor.tools.tool_backend_helpers import managed_nous_tools_enabled
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from calfkit_hermes._shims.hermes_cli.auth import resolve_nous_access_token
