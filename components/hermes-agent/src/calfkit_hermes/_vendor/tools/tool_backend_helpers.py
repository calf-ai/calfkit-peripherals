...
def managed_nous_tools_enabled(*, force_fresh: bool = False) -> bool:
    ...
    """
    try:
        from calfkit_hermes._shims.hermes_cli.nous_account import get_nous_portal_account_info
...
def nous_tool_gateway_unavailable_message(
    ...
    *,
    ...
    try:
        from calfkit_hermes._shims.hermes_cli.nous_account import (
...
def fal_key_is_configured() -> bool:
    ...
    if value is None:
        ...
        try:
            from calfkit_hermes._shims.hermes_cli.config import get_env_value
