# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_write_deny.py
...
from calfkit_tools.hermes._vendor.tools.file_operations import _is_write_denied
...
class TestWriteDenyExactPaths:
    ...
    def test_hermes_root_env_when_running_under_profile(self, tmp_path, monkeypatch):
        ...
        from calfkit_tools.hermes._vendor.hermes_constants import get_hermes_home, get_default_hermes_root
...
class TestWriteDenyPrefixes:
    ...
    def test_systemd_prefix(self, tmp_path):
        ...
        import calfkit_tools.hermes._vendor.agent.file_safety as _fs
