# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_line_ending_preservation.py
...
def hermes_home(monkeypatch, tmp_path):
    ...
    try:
        from calfkit_tools.hermes._vendor.tools.file_tools import clear_file_ops_cache, _read_tracker_lock, _read_tracker
...
class TestPatchCRLFPreservation:
    def test_patch_on_crlf_file_stays_pure_crlf(self, hermes_home, tmp_path):
        ...
        no mixed endings."""
        from calfkit_tools.hermes._vendor.tools.file_tools import _handle_patch
...
class TestLineEndingHelpers:
    ...
    def test_detect_crlf(self):
        from calfkit_tools.hermes._vendor.tools.file_operations import _detect_line_ending
    ...
    def test_normalize_to_lf_strips_cr(self):
        from calfkit_tools.hermes._vendor.tools.file_operations import _normalize_line_endings
