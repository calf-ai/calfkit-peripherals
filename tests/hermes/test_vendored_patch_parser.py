# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_patch_parser.py
...
class TestCountOccurrences:
    def test_basic(self):
        from calfkit_tools.hermes._vendor.tools.patch_parser import _count_occurrences
