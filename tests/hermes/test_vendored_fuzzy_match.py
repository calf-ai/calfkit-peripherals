# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_fuzzy_match.py
# Imports rewritten to the calfkit_tools.hermes._vendor namespace; otherwise verbatim.
...
class TestFindClosestLines:
    def setup_method(self):
        from calfkit_tools.hermes._vendor.tools.fuzzy_match import find_closest_lines
