# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_file_read_guards.py
...
class TestDevicePathBlocking(unittest.TestCase):
    ...
    def test_proc_fd_other_not_blocked(self):
        ...
        from calfkit_tools.hermes._vendor.tools.file_tools import _is_blocked_device_path
...
class TestCharacterCountGuard(unittest.TestCase):
    ...
    @patch("calfkit_tools.hermes._vendor.tools.file_tools._get_file_ops")
    @patch("calfkit_tools.hermes._vendor.tools.file_tools._get_max_read_chars", return_value=_DEFAULT_MAX_READ_CHARS)
...
class TestConfigOverride(unittest.TestCase):
    ...
    def setUp(self):
        ...
        import calfkit_tools.hermes._vendor.tools.file_tools as _ft
    ...
    @patch("calfkit_tools.hermes._vendor.tools.file_tools._get_file_ops")
    @patch("calfkit_tools.hermes._shims.hermes_cli.config.load_config", return_value={"file_read_max_chars": 50})
    ...
    @patch("calfkit_tools.hermes._vendor.tools.file_tools._get_file_ops")
    @patch("calfkit_tools.hermes._shims.hermes_cli.config.load_config", return_value={"file_read_max_chars": 500_000})
