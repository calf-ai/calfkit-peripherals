# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_local_tempdir.py
...
class TestLocalTempDir:
    ...
    def test_falls_back_to_tempfile_when_tmp_missing(self, monkeypatch):
        ...
        with patch("calfkit_tools.hermes._vendor.tools.environments.local.os.path.isdir", return_value=False), \
             patch("calfkit_tools.hermes._vendor.tools.environments.local.os.access", return_value=False), \
             patch("calfkit_tools.hermes._vendor.tools.environments.local.tempfile.gettempdir", return_value="/cache/tmp"), \
