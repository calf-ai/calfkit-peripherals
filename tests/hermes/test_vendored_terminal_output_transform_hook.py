# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_terminal_output_transform_hook.py
...
import calfkit_tools.hermes._shims.hermes_cli.plugins as plugins_mod
import calfkit_tools.hermes._vendor.tools.terminal_tool as terminal_tool_module
...
def _run_terminal(
    ...
    *,
    ...
    if invoke_hook is not _UNSET:
        monkeypatch.setattr("calfkit_tools.hermes._shims.hermes_cli.plugins.invoke_hook", invoke_hook)
...
def test_terminal_output_transform_still_runs_strip_and_redact(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("calfkit_tools.hermes._vendor.agent.redact._REDACT_ENABLED", True)
