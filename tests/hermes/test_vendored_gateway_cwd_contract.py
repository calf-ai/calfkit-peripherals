# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_gateway_cwd_contract.py
...
from calfkit_tools.hermes._vendor.tools import code_execution_tool, file_tools, terminal_tool
