# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_file_staleness.py
...
class TestCheckFileStalenessHelper(unittest.TestCase):
    ...
    def test_returns_none_for_unread_file(self):
        ...
        from calfkit_tools.hermes._vendor.tools.file_tools import _read_tracker, _read_tracker_lock
