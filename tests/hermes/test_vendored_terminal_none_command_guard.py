# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_terminal_none_command_guard.py
...
from calfkit_tools.hermes._vendor.tools.terminal_tool import _transform_sudo_command, terminal_tool
