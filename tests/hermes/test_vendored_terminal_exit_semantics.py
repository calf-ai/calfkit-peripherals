# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_terminal_exit_semantics.py
...
from calfkit_tools.hermes._vendor.tools.terminal_tool import _interpret_exit_code
