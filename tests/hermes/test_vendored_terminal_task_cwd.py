# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_terminal_task_cwd.py
...
import calfkit_tools.hermes._vendor.tools.terminal_tool as terminal_tool
...
def test_background_command_prefers_live_env_cwd_over_init_time_cwd(monkeypatch):
    ...
    import calfkit_tools.hermes._vendor.tools.process_registry as process_registry_mod
