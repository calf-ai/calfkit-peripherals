# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_hardline_blocklist.py
...
def test_approvals_mode_off_cannot_bypass_hardline(clean_session, monkeypatch, tmp_path):
    ...
    import calfkit_tools.hermes._vendor.tools.approval as approval_mod
