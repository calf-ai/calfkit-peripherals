# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_local_env_windows_msys.py
...
from calfkit_tools.hermes._vendor.tools.environments import local as local_mod
