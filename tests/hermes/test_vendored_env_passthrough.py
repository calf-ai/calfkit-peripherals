# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_env_passthrough.py
...
import calfkit_tools.hermes._vendor.tools.env_passthrough as _ep_mod
from calfkit_tools.hermes._vendor.tools.env_passthrough import (
...
class TestTerminalIntegration:
    ...
    def test_blocklisted_var_blocked_by_default(self):
        from calfkit_tools.hermes._vendor.tools.environments.local import _sanitize_subprocess_env, _HERMES_PROVIDER_ENV_BLOCKLIST
