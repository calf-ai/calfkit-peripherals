# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_threaded_process_handle.py
...
from calfkit_tools.hermes._vendor.tools.environments.base import _ThreadedProcessHandle
