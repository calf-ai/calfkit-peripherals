# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_file_operations_edge_cases.py
...
from calfkit_tools.hermes._vendor.tools.file_operations import ShellFileOperations, _parse_search_context_line
