# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_local_shell_init.py
...
class TestResolveShellInitFiles:
    def test_auto_sources_bashrc_when_present(self, tmp_path, monkeypatch):
        ...
        with patch(
            "calfkit_tools.hermes._vendor.tools.environments.local._read_terminal_shell_init_config",
            return_value=([], True),
        ):
