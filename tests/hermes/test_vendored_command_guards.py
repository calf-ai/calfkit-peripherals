# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_command_guards.py
...
import calfkit_tools.hermes._vendor.tools.approval as approval_module
...
import calfkit_tools.hermes._vendor.tools.tirith_security
...
_TIRITH_PATCH = "calfkit_tools.hermes._vendor.tools.tirith_security.check_command_security"
...
class TestTirithImportError:
    def test_import_error_allows(self):
        ...
        original = sys.modules.get("calfkit_tools.hermes._vendor.tools.tirith_security")
        sys.modules["calfkit_tools.hermes._vendor.tools.tirith_security"] = None  # causes ImportError on from-import
        try:
            result = check_all_command_guards("echo hello", "local")
            assert result["approved"] is True
        finally:
            if original is not None:
                sys.modules["calfkit_tools.hermes._vendor.tools.tirith_security"] = original
            else:
                sys.modules.pop("calfkit_tools.hermes._vendor.tools.tirith_security", None)
