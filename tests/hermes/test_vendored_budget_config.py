# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_budget_config.py
...
from calfkit_tools.hermes._vendor.tools.budget_config import (
    DEFAULT_BUDGET,
...
class TestResolveThreshold:
    ...
    @patch("calfkit_tools.hermes._vendor.tools.registry.registry")
