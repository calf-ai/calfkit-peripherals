# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_registry.py
...
from calfkit_tools.hermes._vendor.tools.registry import ToolRegistry, _module_registers_tools, discover_builtin_tools
...
class TestBuiltinDiscovery:
    def test_discovers_all_real_self_registering_builtin_tool_modules(self):
        ...
        with patch("calfkit_tools.hermes._vendor.tools.registry.importlib.import_module"):
    ...
    def test_imports_only_self_registering_modules(self, tmp_path):
        ...
        with patch("calfkit_tools.hermes._vendor.tools.registry.importlib.import_module") as mock_import:
            imported = discover_builtin_tools(tools_dir)
