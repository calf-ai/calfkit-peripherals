# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_init_session_cwd_respect.py
...
from calfkit_tools.hermes._vendor.tools.environments.base import BaseEnvironment
