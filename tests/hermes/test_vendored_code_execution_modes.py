# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_code_execution_modes.py
...
def _mock_mode(mode):
    ...
    with patch("calfkit_tools.hermes._vendor.tools.code_execution_tool._load_config",
...
class TestGetExecutionMode(unittest.TestCase):
    ...
    def test_empty_config_falls_back_to_default(self):
        with patch("calfkit_tools.hermes._vendor.tools.code_execution_tool._load_config", return_value={}):
