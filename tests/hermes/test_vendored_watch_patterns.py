# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_watch_patterns.py
...
class TestCheckpointPersistence:
    def test_watch_patterns_in_checkpoint(self, registry):
        ...
        with patch("calfkit_tools.hermes._vendor.utils.atomic_json_write") as mock_write:
    ...
    def test_watch_patterns_recovery(self, registry, tmp_path, monkeypatch):
        ...
        import calfkit_tools.hermes._vendor.tools.process_registry as pr_mod
...
class TestTerminalToolSchema:
    ...
    def test_handler_passes_watch_patterns(self):
        ...
        from calfkit_tools.hermes._vendor.tools.terminal_tool import _handle_terminal
        with patch("calfkit_tools.hermes._vendor.tools.terminal_tool.terminal_tool") as mock_tt:
...
class TestCodeExecutionBlocked:
    def test_watch_patterns_blocked(self):
        from calfkit_tools.hermes._vendor.tools.code_execution_tool import _TERMINAL_BLOCKED_PARAMS
...
class TestMutualExclusion:
    def test_resolver_drops_watch_when_notify_set(self):
        ...
        from calfkit_tools.hermes._vendor.tools.terminal_tool import _resolve_notification_flag_conflict
