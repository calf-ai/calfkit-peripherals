# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_file_write_safety.py
...
class TestCheckSensitivePathMacOSBypass:
    ...
    def test_etc_hosts_blocked(self):
        from calfkit_tools.hermes._vendor.tools.file_tools import _check_sensitive_path
...
class TestBomHandling:
    ...
    def test_helpers(self):
        from calfkit_tools.hermes._vendor.tools.file_operations import _strip_bom, _has_bom
