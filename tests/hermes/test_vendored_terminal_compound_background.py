# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_terminal_compound_background.py
...
from calfkit_tools.hermes._vendor.tools.terminal_tool import _rewrite_compound_background as rewrite
