# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_accretion_caps.py
...
class TestReadTrackerCaps:
    def setup_method(self):
        from calfkit_tools.hermes._vendor.tools import file_tools
    ...
    def test_read_history_capped(self, monkeypatch):
        ...
        from calfkit_tools.hermes._vendor.tools import file_tools as ft
...
class TestCompletionConsumedPrune:
    def test_prune_drops_completion_entry_with_expired_session(self):
        ...
        from calfkit_tools.hermes._vendor.tools.process_registry import ProcessRegistry, FINISHED_TTL_SECONDS
        import time
    ...
    def test_prune_clears_dangling_completion_entries(self):
        ...
        from calfkit_tools.hermes._vendor.tools.process_registry import ProcessRegistry
