# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_file_tools_container_config.py
...
import calfkit_tools.hermes._vendor.tools.file_tools as file_tools
...
class TestFileToolsContainerConfig:
    def _run(self, env_config, task_id):
        ...
        with patch("calfkit_tools.hermes._vendor.tools.terminal_tool._get_env_config", return_value=env_config),              patch("calfkit_tools.hermes._vendor.tools.terminal_tool._task_env_overrides", {}),              patch("calfkit_tools.hermes._vendor.tools.terminal_tool._active_environments", {}),              patch("calfkit_tools.hermes._vendor.tools.terminal_tool._creation_locks", {}),              patch("calfkit_tools.hermes._vendor.tools.terminal_tool._creation_locks_lock", __import__("threading").Lock()),              patch("calfkit_tools.hermes._vendor.tools.terminal_tool._create_environment", side_effect=fake_create_env),              patch("calfkit_tools.hermes._vendor.tools.terminal_tool._start_cleanup_thread"),              patch("calfkit_tools.hermes._vendor.tools.terminal_tool._check_disk_usage_warning"),              patch("calfkit_tools.hermes._vendor.tools.file_tools._file_ops_cache", {}),              patch("calfkit_tools.hermes._vendor.tools.file_tools._file_ops_lock", __import__("threading").Lock()):
