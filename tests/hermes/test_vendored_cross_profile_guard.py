# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_cross_profile_guard.py
...
def fake_hermes(tmp_path, monkeypatch):
    ...
    import calfkit_tools.hermes._vendor.hermes_constants as hermes_constants
    monkeypatch.setattr(hermes_constants, "get_default_hermes_root", lambda: root)

    import calfkit_tools.hermes._vendor.agent.file_safety as fs
...
class TestSkillManageCrossProfileErrorUX:
    ...
    def test_error_names_other_profile_when_skill_lives_there(
        ...
        import importlib
        import calfkit_tools.hermes._vendor.tools.skill_manager_tool
        importlib.reload(tools.skill_manager_tool)
        from calfkit_tools.hermes._vendor.tools.skill_manager_tool import _skill_not_found_error
...
class TestSystemPromptActiveProfile:
    def test_default_profile_line_in_prompt(self, tmp_path, monkeypatch):
        ...
        from calfkit_tools.hermes._vendor.agent.file_safety import _resolve_active_profile_name
