# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_code_execution_windows_env.py
...
class TestSandboxWritesUtf8:
    ...
    def test_file_rpc_stub_uses_utf8(self):
        ...
        from calfkit_tools.hermes._vendor.tools.code_execution_tool import generate_hermes_tools_module
