# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_credential_files.py
...
def _clean_state():
    ...
    import calfkit_tools.hermes._vendor.tools.credential_files as _cred_mod
    clear_credential_files()
