# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_resolve_path.py
...
class TestResolvePath:
    ...
    def test_relative_path_uses_terminal_cwd(self, monkeypatch, tmp_path):
        ...
        from calfkit_tools.hermes._vendor.tools.file_tools import _resolve_path
