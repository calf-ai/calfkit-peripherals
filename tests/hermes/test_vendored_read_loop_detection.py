# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_read_loop_detection.py
...
class TestReadLoopDetection(unittest.TestCase):
    ...
    @patch("calfkit_tools.hermes._vendor.tools.file_tools._get_file_ops", return_value=_make_fake_file_ops())
