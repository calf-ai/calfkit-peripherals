# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_interrupt.py
...
class TestInterruptModule:
    ...
    def test_set_and_check(self):
        from calfkit_tools.hermes._vendor.tools.interrupt import set_interrupt, is_interrupted
        set_interrupt(False)
    ...
    def test_thread_safety(self):
        ...
        from calfkit_tools.hermes._vendor.tools.interrupt import set_interrupt, is_interrupted, _interrupted_threads, _lock
        set_interrupt(False)
