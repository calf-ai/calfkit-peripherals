# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_file_tools_cwd_resolution.py
...
import calfkit_tools.hermes._vendor.tools.file_tools as ft
