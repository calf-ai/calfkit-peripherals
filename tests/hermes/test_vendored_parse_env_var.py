# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_parse_env_var.py
...
import sys
import calfkit_tools.hermes._vendor.tools.terminal_tool  # noqa: F401 -- ensure module is loaded
_tt_mod = sys.modules["calfkit_tools.hermes._vendor.tools.terminal_tool"]
from calfkit_tools.hermes._vendor.tools.terminal_tool import _parse_env_var
