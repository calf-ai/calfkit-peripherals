# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_terminal_tool_pty_fallback.py
...
from calfkit_tools.hermes._vendor.tools import process_registry as process_registry_module
