# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_local_env_cwd_recovery.py
    ...
    def test_recovers_when_cwd_deleted_after_init(self, tmp_path, caplog):
        ...
        try:
            with patch("calfkit_tools.hermes._vendor.tools.environments.local._find_bash", return_value="/bin/bash"), \
                 ...
                 patch("calfkit_tools.hermes._vendor.tools.terminal_tool._interrupt_event", _fake_interrupt()), \
                 caplog.at_level("WARNING", logger="calfkit_tools.hermes._vendor.tools.environments.local"):
