# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_terminal_requirements.py
# Imports + patch-target strings rewritten to calfkit_tools.hermes._vendor/_shims; otherwise verbatim.
import importlib
import logging


terminal_tool_module = importlib.import_module("calfkit_tools.hermes._vendor.tools.terminal_tool")
...
def _clear_terminal_env(monkeypatch):
    ...
    import calfkit_tools.hermes._vendor.tools.tool_backend_helpers as _tbh
