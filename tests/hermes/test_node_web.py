...
from calfkit_tools.hermes._vendor.agent.web_search_provider import WebSearchProvider
from calfkit_tools.hermes._vendor.agent.web_search_registry import (
    _reset_for_tests,
    register_provider,
)
from calfkit_tools.hermes._vendor.tools.url_safety import _reset_allow_private_cache
from calfkit_tools.hermes.node import web
from calfkit_tools.hermes.node.web import web_extract as web_extract_node
from calfkit_tools.hermes.node.web import web_search as web_search_node
...
class TestDormantResolverNeverCalled:
    def test_neither_node_calls_the_top_level_resolvers(self, monkeypatch):
        ...
        bearing assertion.)"""
        import calfkit_tools.hermes._vendor.agent.web_search_registry as reg
