# Vendored from NousResearch/hermes-agent @ 5a36f76 (MIT) -- tests/tools/test_file_tools.py
...
from calfkit_tools.hermes._vendor.tools.file_tools import (
    PATCH_SCHEMA,
)
...
class TestReadFileHandler:
    ...
    def test_returns_file_content(self, mock_get):
        ...
        from calfkit_tools.hermes._vendor.tools.file_tools import read_file_tool
...
class TestWriteFileHandler:
    ...
    def test_writes_content(self, mock_get):
        ...
        from calfkit_tools.hermes._vendor.tools.file_tools import write_file_tool
    ...
    def test_permission_error_returns_error_json_without_error_log(self, mock_get, caplog):
        ...
        from calfkit_tools.hermes._vendor.tools.file_tools import write_file_tool
        with caplog.at_level(logging.DEBUG, logger="calfkit_tools.hermes._vendor.tools.file_tools"):
    ...
    def test_unexpected_exception_still_logs_error(self, mock_get, caplog):
        ...
        from calfkit_tools.hermes._vendor.tools.file_tools import write_file_tool
        with caplog.at_level(logging.ERROR, logger="calfkit_tools.hermes._vendor.tools.file_tools"):
            result = json.loads(write_file_tool("/tmp/out.txt", "data"))
    ...
    def test_missing_content_key_returns_error(self):
        ...
        from calfkit_tools.hermes._vendor.tools.file_tools import _handle_write_file
    ...
    def test_explicit_empty_content_is_allowed(self):
        ...
        with patch("calfkit_tools.hermes._vendor.tools.file_tools._get_file_ops") as mock_get:
            mock_ops = MagicMock()
            result_obj = MagicMock()
...
class TestPatchHandler:
    ...
    def test_replace_mode_calls_patch_replace(self, mock_get):
        ...
        from calfkit_tools.hermes._vendor.tools.file_tools import patch_tool
...
class TestSearchHandler:
    ...
    def test_search_calls_file_ops(self, mock_get):
        ...
        from calfkit_tools.hermes._vendor.tools.file_tools import search_tool
...
class TestSearchHints:
    ...
    def setup_method(self):
        ...
        from calfkit_tools.hermes._vendor.tools.file_tools import _read_tracker
        _read_tracker.clear()
...
class TestSensitivePathCheck:
    ...
    def test_hermes_config_blocked_for_write_file(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("calfkit_tools.hermes._vendor.tools.file_tools._hermes_config_resolved", str(fake_config))
        monkeypatch.setattr("calfkit_tools.hermes._vendor.tools.file_tools._hermes_config_resolved_loaded", True)
    ...
    def test_system_path_still_blocked(self, monkeypatch):
        monkeypatch.setattr("calfkit_tools.hermes._vendor.tools.file_tools._hermes_config_resolved", "/some/other/path")
        monkeypatch.setattr("calfkit_tools.hermes._vendor.tools.file_tools._hermes_config_resolved_loaded", True)
    ...
    def test_normal_file_not_blocked(self, mock_get, monkeypatch):
        monkeypatch.setattr("calfkit_tools.hermes._vendor.tools.file_tools._hermes_config_resolved", "/home/user/.hermes/config.yaml")
        monkeypatch.setattr("calfkit_tools.hermes._vendor.tools.file_tools._hermes_config_resolved_loaded", True)
        mock_ops = MagicMock()
        result_obj = MagicMock()
