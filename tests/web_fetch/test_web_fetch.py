...
_SAFE_DOWNLOAD = 'calfkit_tools.web_fetch._vendor.common_tools.web_fetch.safe_download'
...
class TestWebFetchLocalTool:
    ...
    async def test_oversize_response_raises_web_fetch_error(self):
        ...
        """
        from calfkit_tools.web_fetch._vendor._ssrf import ResponseTooLargeError
    ...
    async def test_byte_cap_fires_before_markdownify(self):
        ...
        with (
            ...
            patch('calfkit_tools.web_fetch._vendor.common_tools.web_fetch.md') as mock_md,
        ):
            tool = WebFetchLocalTool(max_content_length=None, allow_local_urls=False, timeout=30)
