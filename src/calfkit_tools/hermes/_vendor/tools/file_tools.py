...
from calfkit_tools.hermes._vendor.agent.file_safety import get_read_block_error
from calfkit_tools.hermes._vendor.tools.binary_extensions import has_binary_extension
from calfkit_tools.hermes._vendor.tools.file_operations import (
    ShellFileOperations,
    normalize_read_pagination,
    normalize_search_pagination,
)
from calfkit_tools.hermes._vendor.tools import file_state
...
def _get_max_read_chars() -> int:
    ...
    try:
        from calfkit_tools.hermes._shims.hermes_cli.config import load_config
        cfg = load_config()
...
def _get_live_tracking_cwd(task_id: str = "default") -> str | None:
    ...
    try:
        from calfkit_tools.hermes._vendor.tools.terminal_tool import _resolve_container_task_id
    ...
    try:
        from calfkit_tools.hermes._vendor.tools.terminal_tool import _active_environments, _env_lock
...
def _get_hermes_config_resolved() -> str | None:
    ...
    try:
        from calfkit_tools.hermes._shims.hermes_cli.config import get_config_path
...
def _get_file_ops(task_id: str = "default") -> ShellFileOperations:
    ...
    with task_lock:
        ...
        if terminal_env is None:
            from calfkit_tools.hermes._vendor.tools.terminal_tool import _task_env_overrides
...
def patch_tool(mode: str = "replace", path: str = None, old_string: str = None,
    ...
    if mode == "patch" and patch:
        import re as _re
        from calfkit_tools.hermes._vendor.tools.path_security import has_traversal_component
...
def _check_file_reqs():
    ...
    from calfkit_tools.hermes._vendor.tools import check_file_requirements
