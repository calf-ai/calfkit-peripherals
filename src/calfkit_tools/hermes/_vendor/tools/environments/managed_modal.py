...
from calfkit_tools.hermes._vendor.tools.environments.modal_utils import (
    BaseModalExecutionEnvironment,
    ModalExecStart,
    PreparedModalExec,
)
from calfkit_tools.hermes._vendor.tools.managed_tool_gateway import resolve_managed_tool_gateway
...
class ManagedModalEnvironment(BaseModalExecutionEnvironment):
    ...
    def _guard_unsupported_credential_passthrough(self) -> None:
        ...
        try:
            from calfkit_tools.hermes._vendor.tools.credential_files import get_credential_file_mounts
        except Exception:
            return
