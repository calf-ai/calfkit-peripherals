...
from calfkit_tools.hermes._vendor.tools.environments.file_sync import (
    FileSyncManager,
    iter_sync_files,
...
def _ensure_modal_sdk() -> None:
    ...
    try:
        from calfkit_tools.hermes._vendor.tools.lazy_deps import ensure as _lazy_ensure
...
class _AsyncWorker:
    ...
    def run_coroutine(self, coro, timeout=600):
        from calfkit_tools.hermes._vendor.agent.async_utils import safe_schedule_threadsafe
