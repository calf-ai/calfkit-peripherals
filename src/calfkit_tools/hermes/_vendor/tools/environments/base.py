...
from calfkit_tools.hermes._vendor.tools.interrupt import is_interrupted
...
class BaseEnvironment(ABC):
    ...
    def execute(
        ...
        *,
        ...
        if rewrite_compound_background:
            from calfkit_tools.hermes._vendor.tools.terminal_tool import _rewrite_compound_background
    ...
    def _prepare_command(self, command: str) -> tuple[str, str | None]:
        ...
        from calfkit_tools.hermes._vendor.tools.terminal_tool import _transform_sudo_command
