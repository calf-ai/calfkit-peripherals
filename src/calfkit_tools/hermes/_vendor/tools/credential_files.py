...
def register_credential_file(
    ...
    *relative_path* is relative to ``HERMES_HOME`` (e.g. ``google_token.json``).
    ...
    from calfkit_tools.hermes._vendor.tools.path_security import validate_within_dir
...
def get_skills_directory_mount(
    ...
    **Security:** Bind mounts follow symlinks, so a malicious symlink inside
    ...
    try:
        from calfkit_tools.hermes._vendor.agent.skill_utils import get_external_skills_dirs
...
def get_cache_directory_mounts(
    ...
    """
    from calfkit_tools.hermes._vendor.hermes_constants import get_hermes_dir
