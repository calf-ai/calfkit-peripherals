...
from calfkit_tools.hermes._vendor.utils import env_var_enabled, is_truthy_value
...
def save_permanent_allowlist(patterns: set):
    ...
    try:
        from calfkit_tools.hermes._shims.hermes_cli.config import load_config, save_config
        config = load_config()
...
def prompt_dangerous_approval(command: str, description: str,
    ...
    try:
        ...
        from calfkit_tools.hermes._vendor.agent.i18n import t
        while True:
            print()
...
def _smart_approve(command: str, description: str) -> str:
    ...
    """
    try:
        from calfkit_tools.hermes._shims.agent.auxiliary_client import call_llm
...
def check_all_command_guards(command: str, env_type: str,
    ...
    try:
        from calfkit_tools.hermes._vendor.tools.tirith_security import check_command_security
