...
from calfkit_tools.hermes._vendor.tools.thread_context import propagate_context_to_thread
...
def _scrub_child_env(source_env, is_passthrough=None, is_windows=None):
    ...
    if is_passthrough is None:
        try:
            from calfkit_tools.hermes._vendor.tools.env_passthrough import is_env_passthrough as _ep
        except Exception:
...
def _rpc_server_loop(
    ...
    """
    from calfkit_tools.hermes._shims.model_tools import handle_function_call
...
def _get_or_create_env(task_id: str):
    ...
    """
    from calfkit_tools.hermes._vendor.tools.terminal_tool import (
...
def execute_code(
    ...
    from calfkit_tools.hermes._vendor.tools.terminal_tool import _get_env_config
    ...
    from calfkit_tools.hermes._vendor.tools.approval import check_execute_code_guard
    ...
    from calfkit_tools.hermes._vendor.tools.interrupt import is_interrupted as _is_interrupted
    ...
    try:
        ...
        from calfkit_tools.hermes._vendor.hermes_constants import get_subprocess_home
        ...
        while proc.poll() is None:
            ...
            try:
                from calfkit_tools.hermes._vendor.tools.environments.base import touch_activity_if_due
...
def _load_config() -> dict:
    ...
    """
    try:
        from calfkit_tools.hermes._shims.hermes_cli.config import read_raw_config
...
# --- Registry ---
from calfkit_tools.hermes._vendor.tools.registry import registry, tool_error
