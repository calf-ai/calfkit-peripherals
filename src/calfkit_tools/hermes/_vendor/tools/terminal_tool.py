...
from calfkit_tools.hermes._vendor.utils import env_var_enabled
...
# ---------------------------------------------------------------------------
from calfkit_tools.hermes._vendor.tools.interrupt import is_interrupted, _interrupt_event  # noqa: F401 — re-exported
...
from calfkit_tools.hermes._vendor.tools.environments.singularity import _get_scratch_dir
from calfkit_tools.hermes._vendor.tools.tool_backend_helpers import (
    coerce_modal_mode,
...
def _get_sudo_password_cache_scope() -> str:
    ...
    try:
        from calfkit_tools.hermes._shims.gateway.session_context import get_session_env
...
def _handle_sudo_failure(output: str, env_type: str) -> str:
    ...
    for failure in sudo_failures:
        if failure in output:
            from calfkit_tools.hermes._vendor.hermes_constants import display_hermes_home as _dhh
...
from calfkit_tools.hermes._vendor.tools.environments.local import LocalEnvironment as _LocalEnvironment
from calfkit_tools.hermes._vendor.tools.environments.singularity import SingularityEnvironment as _SingularityEnvironment
from calfkit_tools.hermes._vendor.tools.environments.ssh import SSHEnvironment as _SSHEnvironment
from calfkit_tools.hermes._vendor.tools.environments.docker import DockerEnvironment as _DockerEnvironment
from calfkit_tools.hermes._vendor.tools.environments.modal import ModalEnvironment as _ModalEnvironment
from calfkit_tools.hermes._vendor.tools.environments.managed_modal import ManagedModalEnvironment as _ManagedModalEnvironment
from calfkit_tools.hermes._vendor.tools.managed_tool_gateway import is_managed_tool_gateway_ready
import sys
...
def _maybe_reap_docker_orphans(container_config: Dict[str, Any]) -> None:
    ...
    * ``_docker_orphan_reaper_ran`` flag — sweep runs once per Python
    ...
    try:
        from calfkit_tools.hermes._vendor.tools.environments.docker import (
...
def _create_environment(env_type: str, image: str, cwd: str, timeout: int,
    ...
    if env_type == "local":
        ...
        from calfkit_tools.hermes._vendor.tools.environments.daytona import DaytonaEnvironment as _DaytonaEnvironment
...
def _cleanup_inactive_envs(lifetime_seconds: int = 300):
    ...
    try:
        from calfkit_tools.hermes._vendor.tools.process_registry import process_registry
    ...
    for task_id, env in envs_to_stop:
        ...
        try:
            from calfkit_tools.hermes._vendor.tools.file_tools import clear_file_ops_cache
...
def terminal_tool(
    ...
    try:
        ...
        if background:
            ...
            from calfkit_tools.hermes._vendor.tools.approval import get_current_session_key
            from calfkit_tools.hermes._vendor.tools.process_registry import process_registry
            ...
            try:
                ...
                if background and (notify_on_complete or watch_patterns):
                    from calfkit_tools.hermes._shims.gateway.session_context import get_session_env as _gse
            ...
            try:
                from calfkit_tools.hermes._shims.hermes_cli.plugins import invoke_hook
            ...
            from calfkit_tools.hermes._vendor.tools.tool_output_limits import get_max_bytes
            ...
            from calfkit_tools.hermes._vendor.tools.ansi_strip import strip_ansi
            output = strip_ansi(output)

            # Redact secrets from command output (catches env/printenv leaking keys)
            from calfkit_tools.hermes._vendor.agent.redact import redact_sensitive_text
...
def check_terminal_requirements() -> bool:
    ...
    try:
        ...
        if env_type == "local":
            ...
            from calfkit_tools.hermes._vendor.tools.environments.docker import find_docker
            docker = find_docker()
            if not docker:
